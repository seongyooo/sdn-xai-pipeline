...
| 우선순위 | 항목 | 난이도 | 논문 기여 | 상태 |
|---------|------|--------|----------|------|
| 🔴 높음 | Stage 4 iperf 대역폭 검증 | 중 | Digital Twin 정밀도 향상 | ✅ 완료 (2026-07-22) |
| 🔴 높음 | Stage 5 Rollback 영향 XAI 설명 | 중 | XAI 차별화 포인트 | ⬜ 미구현 |
| 🔴 높음 | Stage 1 SFC + reroute action 추가 | 중 | 인텐트 유형 다양화 | ✅ 완료 (2026-07-20) |
| 🟡 중간 | Stage 5 Confidence 점수 | 중 | 정량 평가 가능 | ✅ 완료 (2026-07-20) |
| 🟡 중간 | Stage 2 멀티-플로우 (reroute 경로) | 높음 | 경로 최적화 시연 | ⬜ 미구현 |
| 🟡 중간 | Stage 4 Rollback 정책 선택 | 중 | 운영 현실성 | ⬜ 미구현 |
| 🟢 낮음 | Stage 4 ONOS 토폴로지 동적 구성 | 높음 | 범용성 향상 | ✅ 완료 (커스텀 JSON 기반) |
| 🟢 낮음 | Stage 6 배포 후 모니터링 | 중 | 완성도 | ⬜ 미구현 |
| 🟢 낮음 | Stage 5 반사실적 설명 | 높음 | XAI 심화 | ⬜ 미구현 |
...
| 순위 | 항목 | 난이도 | 논문 임팩트 | 상태 |
|------|------|--------|------------|------|
| 🔴 1 | **B-2 토폴로지 그라운딩** | 낮음 | 환각 억제 — 프롬프트 수정만으로 즉시 효과 | ✅ 완료 (T-D treatment) |
| 🔴 2 | **B-3 정량 평가 프레임워크** | 중 | 논문 5장 수치 근거 필수 | ✅ 완료 (experiments/e1, T-D 결과 확보) |
| 🔴 3 | **B-1 Rejection 처리** | 중 | IR 설계 완성도 + 평가에 필요 | ✅ 완료 (IntentPrediction.status/rejection_reason) |
| 🔴 4 | **Stage 4 iperf 대역폭 검증** | 중 | Digital Twin 정밀도 | ✅ 완료 (2026-07-22) |
| 🔴 5 | **Stage 5 Rollback XAI 설명** | 중 | XAI 차별화 포인트 | ⬜ 미구현 |
| 🟡 6 | **Stage 1 SFC + reroute** | 중 | 인텐트 유형 다양화 | ✅ 완료 (2026-07-20) |
| 🟡 7 | **B-4 Compound Intent** | 중 | 지원 범위 확장 | ✅ 완료 (2026-07-20) |
| 🟡 8 | **Stage 5 Confidence 점수** | 중 | 정량 평가 지원 | ✅ 완료 (2026-07-20) |
| 🟡 9 | **B-5 Repair 루프** | 중 | 자동화 완성도 | ✅ 완료 (repair_utils.py, 2026-07-22) |
| 🟢 10 | Stage 4 Rollback 정책 선택 | 중 | 운영 현실성 | ⬜ 미구현 |
| 🟢 11 | Stage 2 멀티-플로우 (reroute) | 높음 | 경로 최적화 | ⬜ 미구현 |
| 🟢 12 | Stage 6 배포 후 모니터링 | 중 | 완성도 | ⬜ 미구현 |
